/**
 * EL MURO V20.2 - REPARACIÓN FINAL RLS & AVATAR
 */
...
async function postJoke() {
    ...
    if (Date.now() - last < CONFIG.COOLDOWN_MS) return showToast('¡Frena un poco!');
    ...
    try {
        ...
        var col = activeDot ? activeDot.getAttribute('data-color') : '#fff9c4';
